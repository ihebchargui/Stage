...
public class HomepageController {
	...
	private static final String USER_IDENTIFIER_KEY = "SpringBootStore";
	...
	public void createFile() throws Exception {
		...
		File file = new File();
		file.setName("iheb.jpg");

		FileContent content = new FileContent("image/jpeg", new java.io.File("D:\\aa\\che.jpg"));
	...
	public void uploadFileInFolder(HttpServletResponse response) throws Exception {
		...
		FileContent content = new FileContent("image/jpeg", new java.io.File("D:\\aa\\8261.jpg"));
